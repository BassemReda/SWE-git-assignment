 ...
 public static void getmin3nums(String[]arr)
  ...
  if(!Character.isDigit(arr[0].charAt(0))) {
    ...
    public static void DistinctArray(){
    	...
    	String Data = in.next();
		ArrayList<Character> repeated1 = new ArrayList<>();
		for(int i=0; i<Data.length(); i++)
			if(! repeated1.contains(Data.charAt(i)))
				repeated1.add(Data.charAt(i));
		System.out.println("Data Without Repeating: " + repeated1.toString());
	} 
